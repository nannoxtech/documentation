...
// Main function
export const fetchAndExportDBInfo = async () => {
  ...
  try {
    ...
    for (const table of tables) {
      ...
      const markdownFilePath = join(markdownDir, `${table.name}.md`);
      ...
      const jsonFilePath = join(jsonDir, `${table.name}.json`);
